...
public class SelfStepDefinitions {
     ...
     *  Key name  ---->     | first-name | last-name | email                          | password | role                | campus-location | batch-number | team-name      |
     *  Row 0 (get(0) ----> | Lesly      | SDET      | lessleefromb15online@email.com | 1111     | student-team-member | VA              | 15           | Online_Hackers |
     *
     */
    @Then("user verifies that information displays correctly:")
